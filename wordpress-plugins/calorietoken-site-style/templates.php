...
<?php if ((is_page(array(1119,1121,1123,1125,1127,1129,'how-to-buy-cex','how-to-buy-dex','integrated-exchange')) || \CalorieToken\SiteStyle\PublicPages::is_document()) && function_exists('shortcode_exists') && shortcode_exists('xummuser')) : ?>
