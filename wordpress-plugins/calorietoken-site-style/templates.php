...
<template id="ctstyle-header-template"><header class="ctstyle-header ctstyle-header-fallback"><div class="ctstyle-header-inner"><div class="ctstyle-header-brand"><a class="ctstyle-logo" href="<?php echo esc_url(home_url('/')); ?>" aria-label="CalorieToken home"><img src="<?php echo esc_url(content_url('/uploads/2021/12/C-Logotranspa-1024x936.png')); ?>" width="173" height="158" alt="CalorieToken"></a><nav class="ctstyle-header-nav ctstyle-desktop-nav" aria-label="Main navigation"><ul><li><a href="<?php echo esc_url(home_url('/')); ?>">Home</a></li><li><a href="<?php echo esc_url(home_url('/index.php/calorieapp/')); ?>">CalorieApp</a></li><li><a href="<?php echo esc_url(home_url('/index.php/showcases/')); ?>">Showcases</a></li><li><a href="<?php echo esc_url(home_url('/index.php/community-voting-hub-info/')); ?>">Voting Hub</a></li><li><a href="<?php echo esc_url(home_url('/index.php/whitepaper/')); ?>">Whitepaper</a></li><li><a href="<?php echo esc_url(home_url('/index.php/how-to-buy-calorie/')); ?>">CAL &amp; Crypto</a></li><li><a href="<?php echo esc_url(home_url('/index.php/trustline/')); ?>">Trustline</a></li><li><a href="<?php echo esc_url(home_url('/index.php/tokenomics-update/')); ?>">Tokenomics update</a></li><li><a href="<?php echo esc_url(home_url('/index.php/roadmap/')); ?>">Roadmap</a></li><li><a href="<?php echo esc_url(home_url('/index.php/richlist/')); ?>">Richlist</a></li><li><a href="<?php echo esc_url(home_url('/index.php/blog/')); ?>">Blog</a></li><li><a href="<?php echo esc_url(home_url('/index.php/contact/')); ?>">Contact</a></li><li><a href="<?php echo esc_url(home_url('/index.php/collaborate/')); ?>">Meewerken / Collaborate</a></li><li><a href="<?php echo esc_url(home_url('/index.php/faq/')); ?>">FAQ</a></li><li><a href="<?php echo esc_url(home_url('/index.php/donate/')); ?>">Donate</a></li><li><a href="<?php echo esc_url(home_url('/index.php/merchnfts/')); ?>">Merch&amp;NFTs</a></li><li><a href="<?php echo esc_url(home_url('/index.php/contribute-food-data/')); ?>">Contribute Food Data</a></li></ul></nav><details class="ctstyle-header-nav ctstyle-mobile-nav"><summary>Menu</summary><nav aria-label="Main navigation"><ul><li><a href="<?php echo esc_url(home_url('/')); ?>">Home</a></li><li><a href="<?php echo esc_url(home_url('/index.php/calorieapp/')); ?>">CalorieApp</a></li><li><a href="<?php echo esc_url(home_url('/index.php/showcases/')); ?>">Showcases</a></li><li><a href="<?php echo esc_url(home_url('/index.php/community-voting-hub-info/')); ?>">Voting Hub</a></li><li><a href="<?php echo esc_url(home_url('/index.php/whitepaper/')); ?>">Whitepaper</a></li><li><a href="<?php echo esc_url(home_url('/index.php/how-to-buy-calorie/')); ?>">CAL &amp; Crypto</a></li><li><a href="<?php echo esc_url(home_url('/index.php/trustline/')); ?>">Trustline</a></li><li><a href="<?php echo esc_url(home_url('/index.php/tokenomics-update/')); ?>">Tokenomics update</a></li><li><a href="<?php echo esc_url(home_url('/index.php/roadmap/')); ?>">Roadmap</a></li><li><a href="<?php echo esc_url(home_url('/index.php/richlist/')); ?>">Richlist</a></li><li><a href="<?php echo esc_url(home_url('/index.php/blog/')); ?>">Blog</a></li><li><a href="<?php echo esc_url(home_url('/index.php/contact/')); ?>">Contact</a></li><li><a href="<?php echo esc_url(home_url('/index.php/collaborate/')); ?>">Meewerken / Collaborate</a></li><li><a href="<?php echo esc_url(home_url('/index.php/faq/')); ?>">FAQ</a></li><li><a href="<?php echo esc_url(home_url('/index.php/donate/')); ?>">Donate</a></li><li><a href="<?php echo esc_url(home_url('/index.php/merchnfts/')); ?>">Merch&amp;NFTs</a></li><li><a href="<?php echo esc_url(home_url('/index.php/contribute-food-data/')); ?>">Contribute Food Data</a></li></ul></nav></details></div><div class="ctstyle-header-account" hidden></div></div></header></template>
