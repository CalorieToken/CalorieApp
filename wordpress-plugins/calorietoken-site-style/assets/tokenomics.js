...
var locale = new URL(window.location.href).searchParams.get("ui\_lang") || document.documentElement.lang || "en", view = null;
...
|| Array.from(url.searchParams.keys()).some(function (key) { return key !== "ui\_lang"; })
