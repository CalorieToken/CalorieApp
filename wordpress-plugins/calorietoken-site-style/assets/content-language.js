...
(function () {
  ...
  function refresh(tag){
    ...
    document.querySelectorAll('.brz-rich-text,.entry-content,.woocommerce,.woocommerce-notices-wrapper,.ctstyle-roadmap-preview,.calorieapp-context-note,.brz-posts').forEach(function(root){if(!records.has(root))fragments(root);});
