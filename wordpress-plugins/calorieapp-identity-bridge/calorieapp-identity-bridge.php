...
if (!defined('CALORIEAPP_IDENTITY_BRIDGE_VERSION')) {
    define('CALORIEAPP_IDENTITY_BRIDGE_VERSION', '0.3.43');
}
...
add_action('wp_enqueue_scripts', static function (): void {
    ...
    wp_enqueue_script('calorieapp-identity-bridge-navigation', $assets . 'calorieapp-site-navigation.js', [], CALORIEAPP_IDENTITY_BRIDGE_VERSION, true);
}, 20);
