  ...
  return (
    ...
    >
      ...
      <div className="px-4 pb-4 text-sm text-brand-secondary">
        <p>{copy.scope}</p>
        <p className="mt-2 font-semibold">{copy.basis}</p>
            ...
            <li key={food.fdc_id} className="min-w-0 py-4">
              ...
              <dl className="mt-2 grid grid-cols-2 gap-3">
                {metrics.map((metric) => {
                  ...
                  const known = nutrient && nutrient.unit === metric.unit &&
                  ...
                  return (
                    <div key={metric.id} className="min-w-0 break-words">
                      ...
                      <dd className="mt-1 font-semibold">
                        {known ? <bdi>{number.format(nutrient.amount)} {metric.unit}</bdi> : copy.unavailable}
                      </dd>
                    </div>
                  );
                })}
