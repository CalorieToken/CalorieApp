...
const groups: [string, string][] = [
  ...
  ["soup", "soup|soep|sopa|soupe|sup|harira|sambar|شوربة|सूप|স্যুপ|汤|سوپ"],
  ...
  ["bread", "bread|brood|broden|injera|chapati|naan|arepa|volkorenbrood|witbrood|bruinbrood|roggebrood|stokbrood|broodje|broodjes|boterham|boterhammen|toast|bagel|bagels|bun|buns|rolls|baguette|croissant|pita|tortilla|wrap|wraps|tortillas|pan|pain|pao|roti|brot|خبز|ब्रेड|रोटी|রুটি|面包|روٹی"],
  ...
  ["milk", "milk|melk|milch|havermelk|sojamelk|amandelmelk|rijstmelk|oat drink|soy drink|leche|lait|leite|susu|حليب|दूध|দুধ|牛奶|دودھ"],
  ...
  ["rice", "rice|rijst|arroz|jollof|biryani|pilaf|pilau|riz|beras|nasi|ارز|أرز|चावल|ভাত|চাল|米饭|大米|چاول"],
  ...
  ["beans", "bean|beans|dal|dahl|dhal|daal|tempeh|tempe|hummus|houmous|peas|pea|erwten|tofu|soybean|soybeans|sojabonen|bonen|boon|lentil|lentils|linzen|chickpea|chickpeas|kikkererwten|lentille|lentejas|feijao|garbanzo|عدس|चना|মসুর|鹰嘴豆|چنے"],
