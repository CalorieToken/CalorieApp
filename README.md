...
and starts best-effort backend revocation while WordPress ends its session in
the same tab. Logout therefore remains usable while the backend is waking.
...
- Source-neutral assertion catalog: docs/SOURCE_ASSERTION_CATALOG.md
- Bounded source-assertion ingest: docs/SOURCE_ASSERTION_INGEST.md
