...
`20260831_0009` now provide the source, record, moderation, product, link and
assertion schema plus bounded internal assertion admission after the PostgreSQL
compatibility proof. Public write paths, assertion correction and assertion
moderation remain disabled. Enabling a second source is not itself required to
