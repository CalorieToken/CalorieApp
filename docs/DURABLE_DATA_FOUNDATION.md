...
| User portability | Authenticated versioned export, eleven-language download UI and pure fail-closed food-history planning plus clean-target admission exist | Add authenticated transactional import, provider-exit proof, privacy notice and operator publication review |
...
5. Complete authenticated data portability: export and pure import planning plus
   admission exist; authenticated transactional import and provider-exit proof
   remain.
